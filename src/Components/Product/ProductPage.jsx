        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-row gap-10 ">
            ...
            <div className="flex flex-row ">
              <div className="mt-12">
                <div className="flex flex-row space-x-96 ml-10">
                  <h2>
                ...
                <div>
                  <div className="flex flex-row gap-4">
                    <div className="bg-brand md:mt-8 md:w-[268px]  md:h-[432px] w-1/2 rounded-md hover:scale-95 transtion-all duration-300">
