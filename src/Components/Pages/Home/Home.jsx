...
function Home() {
  return (
    <div className="bg-picker  w-full md:h-[632px] h-auto bg-center py-20 flex flex-col items-center justify-center">
      <div className="container md:px-0 px-4"></div>
    </div>
  );
}
...
//                 <h1 className="text-white text-[96px] font-light ">
//                   IPhone 14{" "}
//                 </h1>
